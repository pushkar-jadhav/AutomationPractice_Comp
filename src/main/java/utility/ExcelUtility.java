...
public class ExcelUtility {
	...
	public String getCellData(String sheetName, int colNum, int rowNum) {
		try {
			...
			if (cell.getCellType() == Cell.CELL_TYPE_STRING) {
				//System.out.println(cell.getStringCellValue());  //password
				return cell.getStringCellValue();
			}
			else if (cell.getCellType() == Cell.CELL_TYPE_NUMERIC || cell.getCellType() == Cell.CELL_TYPE_FORMULA) {
	...
	public boolean addColumn(String sheetName, String colName) {
		...
		try {
			...
			//style.setFillPattern(cell.SOLID_FOREGROUND);
...
/*public static void main(String[] args) throws IOException {
		...
		excel.getRowCount("Credentials");
		excel.getColumnCount("Credentials");
		excel.isSheetExist("Credentials");
		//excel.getCellData("Credentials", "Password", 2);
		for(int i=3;i<=excel.getRowCount("credential");i++) {
			String username = excel.getCellData("credentials", "Username", i);
